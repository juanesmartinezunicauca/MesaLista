...
@Component({
  imports: [RouterOutlet, ListaProductosComponent, SidebarComponent, Layout, ProductoFormComponent, BorradorPedidoComponent, DetalleMesaComponent, ListaUsuariosComponent, MiPerfilDialogComponent],
  selector: 'app-root',
  styleUrl: './app.scss',
